  ...
  return {
    ...
    <section>
      ...
      >
        ...
        <p>Hi <b>${username}</b>,</p>
        <p>
          Thank you for submitting your contributer application for becoming a
          part of our contributer team. In the meantime feel free to check out
  ...
  return {
    ...
    html: `
      ...
      >
        ...
        <p>Hi <b>${username}</b>,</p>
        <p>
          Congratulations, you've been approved to be a contributer! We are grateful
        ...
        <p>
          As a newly appointed contributer, we want to show you how to use our
          platform and help you stay on top of your game. <b>Practiwiz</b> is
          such a great tool for both students looking for knowledge and contributers
  ...
  return {
    ...
    html: `
      ...
      >
        ...
        <p>Hi <b>${username}</b>,</p>
        <p>
          Unfortunately, we are unable to approve you as a contributer at this time.
          ...
          teaching and contributering experience, and more.
        </p>
        <p>
          We're sorry for any inconvenience this may cause. If you have any
          questions about the process or requirements for contributering please get
