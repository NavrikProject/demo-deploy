...
// import { emailActivationTemplate } from "../../middleware/authEmailTemplate.js";
// import {
//   contributerApplicationEmail,
//   contributerApproveEmail,
// } from "../../middleware/contributerEmailTemplates.js";
...
//           const msg = emailActivationTemplate(
//             lowEmail,
//             firstname + " " + lastname,
//             url
//           );
...
//                           if (success) {
//                             sgMail.setApiKey(process.env.SENDGRID_API_KEY);
//                             const msg = contributerApplicationEmail(
//                               email,
//                               fullname
//                             );
//                             sgMail
...
//             const fullname = result.recordset[0].contributer_fullname;
...
//                 if (result) {
//                   sgMail.setApiKey(process.env.SENDGRID_API_KEY);
//                   const msg = contributerApproveEmail(email, fullname);
//                   sgMail
//                     .send(msg)
//                     .then(() => {
//                       res.send({
